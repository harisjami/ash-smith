...
export const IMG = {
  ...
  // your own viking axe & shield photos — drop the files into public/images/
  axeSet1: "images/axeSet1.jpg", // crossed axes over the round shield
  axeSet2: "images/axeSet2.jpg", // forge bench: twisted guard & fittings
...
export const IMG_FALLBACK: Record<string, string> = {
  ...Object.fromEntries(Object.entries(REMOTE).map(([k, url]) => [`images/${k}.jpg`, url])),
  "images/axeSet1.jpg": REMOTE.axeShields, // stand-in until your photo is uploaded
  "images/axeSet2.jpg": REMOTE.axeArmory, // stand-in until your photo is uploaded
};
