...
export const products: Product[] = [
  ...
  { id: "viking-axe-set", name: "Handmade Set Of Viking Axe With Shield", spec: "Bearded axe · Linden round shield", category: "Viking Axe", rating: 5, reviews: "58", price: 480, oldPrice: 639.99, img: IMG.axeWarrior, gallery: [IMG.axeWarrior, IMG.axeShields, IMG.axeArmory], description: "A matched war-set from one fire — a hand-forged bearded axe with a shaped ash haft and leather-wrapped grip, paired with a round linden shield bound in rawhide and bossed in steel. Forged to hang together on the same wall." },
...
export const categoryStrip: { name: CategoryName | "All"; img: string }[] = [
  ...
  { name: "Viking Axe", img: IMG.axeWarrior },
];
...
export const categoryMeta: { name: CategoryName; items: string; img: string; blurb: string }[] = [
  ...
  { name: "Viking Axe", items: "450+ items", img: IMG.axeWarrior, blurb: "Bearded axes & round shields" },
];
...
export const categoryTiles: CategoryTile[] = [
  ...
  { name: "Viking Axe", img: IMG.axeWarrior, blurb: "Bearded axes & round shields", filter: inCat("Viking Axe") },
