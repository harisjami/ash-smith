...
const STORIES: Story[] = [
  { id: "viking", label: "Viking", img: "images/viking-seax.png", time: "1h", caption: "New from the forge — a rune-carved damascus seax with a bone grip inscribed in elder futhark. One piece, $190.", cta: "Order the Seax", go: "product", target: "viking-seax" },
  { id: "s1", label: "Heritage", img: "images/knife-hero.png", time: "2h", caption: "The Heritage folder is back — 67 damascus layers, copper soul, horn handle.", cta: "Order the Heritage", go: "product", target: "knife-heritage" },
  { id: "s2", label: "Pocket", img: "images/pocket-knife.png", time: "4h", caption: "Handmade small pocket knife. One antler tine, one jute wrap, one honest edge.", cta: "Order the pocket knife", go: "product", target: "knife-pocket" },
  { id: "s3", label: "Chef Set", img: "images/chef-set.png", time: "6h", caption: "Five-piece damascus chef set — hammered faces, twisted steel handles. Forged to order.", cta: "Order the chef set", go: "product", target: "chef-set-5" },
  { id: "s4", label: "Custom", img: "images/knife-folded.png", time: "9h", caption: "The Custom Forge is open. Pick steel, handle and guard — we hammer the rest.", cta: "Start your build", go: "custom" },
  { id: "s5", label: "48h Deal", img: "images/chef-handles.png", time: "12h", caption: "Flash window: chef knives marked down for 48 hours only. Then the fire dies.", cta: "See the deal", go: "category", target: "Chef Knives" },
  { id: "s6", label: "Workshop", img: "https://images.pexels.com/photos/33508936/pexels-photo-33508936.jpeg?auto=compress&cs=tinysrgb&w=650", time: "1d", caption: "Inside the workshop — engraving day. Floral scroll No. 9 on a copper bolster.", cta: "Browse folders", go: "category", target: "Folding Knives" },
];
