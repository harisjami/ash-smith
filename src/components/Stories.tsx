...
const STORIES: Story[] = [
  { id: "viking-axe", label: "Viking Axe", img: IMG.axeWarrior, time: "10m", caption: "Bearded axe and round shield, forged as a matched set — ash haft, rawhide-bound linden. $480 this batch only.", cta: "Order the Set", go: "product", target: "viking-axe-set" },
