...
const team = [
  { name: "Ash Rourke", role: "Founder & Master Bladesmith", img: IMG.teamAsh, bio: "Third-generation smith who lit the first Forge Of Ash coal in 2016. Every damascus billet starts under his hammer." },
  { name: "Mira Solis", role: "Forge Lead", img: IMG.teamMira, bio: "Runs the daily heat — from billet to blank. Mira keeps the forge at temperature and the queue of commissions moving." },
  { name: "Dario Venn", role: "Heat-Treat Specialist", img: IMG.teamDario, bio: "Owns the quench and the temper. Dario's charts are why our edges hold at 60 HRC without ever turning brittle." },
  { name: "Elena Marsh", role: "Handle & Guard Artisan", img: IMG.teamElena, bio: "Shapes antler, horn and walnut to the palm, then engraves the copper bolsters — one floral scroll at a time." },
  { name: "Kael Brandt", role: "Edge & Finish", img: IMG.teamKael, bio: "The last hands a blade meets. Kael hones every edge to shaving sharp and signs off before it ships to you." },
];
